    ...
    <section id="experiencia" className="py-24 bg-burgundy-dark">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-10 max-w-6xl mx-auto">
          ...
          <div
            className="bg-burgundy/40 backdrop-blur-sm border border-gold/20 rounded-2xl p-8 opacity-0 animation-delay-200"
        ...
        <div className="mt-16 max-w-4xl mx-auto bg-burgundy/30 border border-gold/20 rounded-2xl p-8 opacity-0 animation-delay-400" data-animate="fade-in-up">
