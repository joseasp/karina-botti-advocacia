    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="max-w-3xl">
          <div className="mb-6">
            <span className="inline-block px-4 py-2 bg-gold/20 border border-gold/40 rounded-full text-gold text-sm font-medium tracking-wider uppercase">
              OAB/MG 111.637
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button
              ...
              asChild
            >
              <a href="mailto:contato@karinabotti.adv.br">Enviar E-mail</a>
            </Button>
          </div>
        </div>
      </div>
